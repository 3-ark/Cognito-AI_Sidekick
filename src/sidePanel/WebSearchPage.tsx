...
const GoogleCustomSearchSettingsPanel = ({ config, updateConfig }: GoogleCustomSearchSettingsPanelProps) => {
  ...
  return (
    <div className="w-full space-y-4">
      <div>
        <Label className="text-[var(--text)] text-base font-medium pb-1 block" htmlFor="googleApiKey">
          Google API Key
        </Label>
        <Input
          className="h-6"
      ...
      <div className="pt-2">
        <Label className="text-[var(--text)] text-base font-medium pb-1 block" htmlFor="googleCx">
          Search Engine ID (CX)
        </Label>
        <Input
          className="h-6"
